...
public class JSONHelper {
	...
	private static void serializeMap(JSONStringer js, Object obj) {
		try {
			js.object();
			Map map = (Map) obj;
	 ...
	 * @param valMap
	 */
	private static void setFieldValue(Object obj, Map<String, String> valMap) {
	 ...
	 * @param jo
	 */
	public static void setField(Object obj, Field f, JSONObject jo) {
		String name = f.getName();
		Class<?> clazz = f.getType();
		try {
			if (isArray(clazz)) { // 数组
